...
function Home() {
  ...
  return (
    <main>
      {/* HERO SECTION */}
      <section className="relative h-[600px] bg-blue-900 flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-red-400 uppercase tracking-widest text-sm font-medium">
            ...
            <div className="flex gap-4">
              ...
              <Link
                to="/about"
                className="border-2 border-white text-white hover:bg-white hover:text-blue-900 px-8 py-3 rounded font-medium transition-colors"
              >
                Learn More
              </Link>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="h-1 w-12 bg-red-500" />
                <span className="text-red-500 uppercase tracking-widest text-sm font-medium">About Us</span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                ...
                <div>
                  <div className="text-3xl font-bold text-red-500">3,500</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="flex items-center justify-center gap-2 mb-4">
              <div className="h-1 w-12 bg-red-500" />
              <span className="text-red-500 uppercase tracking-widest text-sm font-medium">What We Do</span>
              <div className="h-1 w-12 bg-red-500" />
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-12">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <div className="h-1 w-12 bg-red-500" />
                <span className="text-red-500 uppercase tracking-widest text-sm font-medium">Portfolio</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-blue-900">Projects in Focus</h2>
            </div>
            <Link
              to="/projects"
              className="hidden md:inline-flex items-center text-red-500 font-medium hover:text-red-600"
            >
              View All Projects
              <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {projects.map((project, idx) => (
              <div key={idx} className="group cursor-pointer">
                ...
                <h3 className="text-xl font-bold text-blue-900 group-hover:text-red-500 transition-colors">
                  {project.title}
                </h3>
          ...
          <div className="mt-8 text-center md:hidden">
            <Link
              to="/projects"
              className="inline-flex items-center text-red-500 font-medium"
            >
              View All Projects
              <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
